...
echo "Make toolchain"
$HOME/android-ndk/android-ndk-r13b/build/tools/make-standalone-toolchain.sh --toolchain=x86_64-linux-android --platform=android-8 --install-dir="$HOME/android-toolchain"
ls -lh $HOME
