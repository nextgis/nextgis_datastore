...
bool MapStore::undo(unsigned char mapId) const
{
    MapViewPtr map = getMap(mapId);
    if(!map)
        return false;
...
bool MapStore::redo(unsigned char mapId) const
{
    MapViewPtr map = getMap(mapId);
    if(!map)
        return false;
...
bool MapStore::canUndo(unsigned char mapId) const
{
    MapViewPtr map = getMap(mapId);
    if(!map)
        return false;
...
bool MapStore::canRedo(unsigned char mapId) const
{
    MapViewPtr map = getMap(mapId);
    if(!map)
        return false;
...
bool MapStore::saveEdit(unsigned char mapId) const
{
    MapViewPtr map = getMap(mapId);
    if(!map)
        return false;
...
bool MapStore::cancelEdit(unsigned char mapId) const
{
    MapViewPtr map = getMap(mapId);
    if(!map)
        return false;
    return map->cancelEdit();
}

bool MapStore::createGeometry(unsigned char mapId, const Layer* layer) const
{
    MapViewPtr map = getMap(mapId);
    if(!map)
        return false;
    return map->createGeometry(layer);
}

bool MapStore::addGeometryPart(unsigned char mapId) const
{
    MapViewPtr map = getMap(mapId);
    if(!map)
        return false;
    return map->addGeometryPart();
}

bool MapStore::deleteGeometryPart(unsigned char mapId) const
{
    MapViewPtr map = getMap(mapId);
    if(!map)
        return false;
    return map->deletePart();
}
