...
TEST(MIStoreTests, TestCreate) {
    ...
    EXPECT_STREQ(ngsCatalogObjectProperty(miFC, "is_readonly", "YES", ""), "NO");
...
TEST(MIStoreTests, TestLogEdits) {
    ...
    ngsCatalogObjectSync(mistore, SMT_UNKNOWN, nullptr, nullptr, nullptr);
    ...
    ASSERT_NE(tab, nullptr);
    ngsFeatureChange *ops = ngsFeatureClassGetEditOperations(tab);
