...
if(NOT BUILD_TARGET_PLATFORM STREQUAL "Desktop")
    ...
    set(WITH_PNG ON CACHE BOOL "PNG on" FORCE)
...
find_anyproject(OpenSSL REQUIRED SHARED OFF CMAKE_ARGS
    ...
    -DOPENSSL_NO_ASAN=ON
    -DOPENSSL_NO_ASM=ON
#    -DOPENSSL_NO_ASYNC=ON
#    -DOPENSSL_NO_AUTOALGINIT=ON
#    -DOPENSSL_NO_AUTOERRINIT=ON
    -DOPENSSL_NO_BF=ON
    -DOPENSSL_NO_BLAKE2=ON
    -DOPENSSL_NO_CAMELLIA=ON
#    -DOPENSSL_NO_CAPIENG=ON
    -DOPENSSL_NO_CAST=ON
    -DOPENSSL_NO_CHACHA=ON
    -DOPENSSL_NO_CMAC=ON
    -DOPENSSL_NO_CMS=ON
    -DOPENSSL_NO_COMP=ON
...
#    -DOPENSSL_NO_DES=ON <-- Need fot NTLM
    -DOPENSSL_NO_DGRAM=ON
#    -DOPENSSL_NO_DH=ON
#    -DOPENSSL_NO_DSA=ON
#    -DOPENSSL_NO_DSO=ON
    -DOPENSSL_NO_DTLS=ON
...
#    -DOPENSSL_NO_ERR=ON
    ...
    -DOPENSSL_NO_HW=ON
    -DOPENSSL_NO_IDEA=ON
    -DOPENSSL_NO_MAKEDEPEND=ON
    -DOPENSSL_NO_MD2=ON
    -DOPENSSL_NO_MD4=ON
    -DOPENSSL_NO_MDC2=ON
    -DOPENSSL_NO_MSAN=ON
    -DOPENSSL_NO_MULTIBLOCK=ON
    -DOPENSSL_NO_NEXTPROTONEG=ON
    -DOPENSSL_NO_OCB=ON
    -DOPENSSL_NO_OCSP=ON
#    -DOPENSSL_NO_PIC=ON
    -DOPENSSL_NO_POLY1305=ON
#    -DOPENSSL_NO_POSIX_IO=ON
    -DOPENSSL_NO_PSK=ON
    -DOPENSSL_NO_RC2=ON
    -DOPENSSL_NO_RC4=ON
    -DOPENSSL_NO_RC5=ON
    -DOPENSSL_NO_RDRAND=ON
    -DOPENSSL_NO_RFC3779=ON
#    -DOPENSSL_NO_RMD160=ON
    -DOPENSSL_NO_SCRYPT=ON
    -DOPENSSL_NO_SCTP=ON
    -DOPENSSL_NO_SEED=ON
    -DOPENSSL_NO_SHARED=ON
#    -DOPENSSL_NO_SOCK=ON
    -DOPENSSL_NO_SRP=ON
    -DOPENSSL_NO_SRTP=ON
#    -DOPENSSL_NO_SSE2=ON
...
#    -DOPENSSL_NO_STDIO=ON
#    -DOPENSSL_NO_THREADS=ON
#    -DOPENSSL_NO_TLS=ON
    -DOPENSSL_NO_TS=ON
    -DOPENSSL_NO_UBSAN=ON
#    -DOPENSSL_NO_UI=ON
    -DOPENSSL_NO_UNIT_TEST=ON
    -DOPENSSL_NO_WHIRLPOOL=ON
#    -DOPENSSL_NO_WEAK_SSL_CIPHERS=ON
) # TODO: disable max algs VERSION 1.0.2 EXACT
...
find_anyproject(GDAL REQUIRED VERSION 2.3.0 EXACT SHARED OFF CMAKE_ARGS
